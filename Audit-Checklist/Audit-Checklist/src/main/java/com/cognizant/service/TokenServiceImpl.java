...
public class TokenServiceImpl implements TokenService {
	...
	public Boolean checkTokenValidity(String token)  {
		...
		try {
			...
			//Get token as response entity - boolean type
			ResponseEntity<Boolean> responseEntity = authClient.getValidity(token);

			if(responseEntity==null) throw new FeignProxyException();
